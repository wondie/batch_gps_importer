...
class Ui_BatchGpsImporter(object):
    def setupUi(self, BatchGpsImporter):
        ...
        BatchGpsImporter.resize(531, 387)
        ...
        self.gridLayout.addLayout(self.notification_bar, 5, 1, 1, 3)
        ...
        self.output_shp_file = QtGui.QLineEdit(self.validation_tab)
        self.output_shp_file.setObjectName(_fromUtf8("output_shp_file"))
        self.gridLayout_2.addWidget(self.output_shp_file, 5, 1, 1, 2)
        self.pushButton = QtGui.QPushButton(self.validation_tab)
        ...
        self.lineEdit = QtGui.QLineEdit(self.validation_tab)
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.gridLayout_2.addWidget(self.lineEdit, 4, 1, 1, 2)
        self.output_shp_file_btn = QtGui.QPushButton(self.validation_tab)
        self.output_shp_file_btn.setObjectName(_fromUtf8("output_shp_file_btn"))
        self.gridLayout_2.addWidget(self.output_shp_file_btn, 5, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.exclude_with_few_points, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.no_exclude_few_points, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.extent_box, 0, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.no_exclude_with_errors_rbtn, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.exclude_with_errors_rbtn, 2, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 472, 277))
    ...
    def retranslateUi(self, BatchGpsImporter):
        ...
        self.extent_box.setTitle(_translate("BatchGpsImporter", "Exclude outside extent", None))
        self.extent_box.setTitleBase(_translate("BatchGpsImporter", "Exclude outside extent", None))
